...
const botCommands = [
  ...
  { command: "x_login", description: "Open the reusable X browser session" },
  { command: "x_status", description: "Check the X browser session" },
  { command: "x_close", description: "Close the X browser session" },
  { command: "handle", description: "Get recent posts from an X handle" },
